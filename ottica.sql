...
--
-- Host: 127.0.0.1
-- Creato il: Gen 08, 2023 alle 21:19
...
(24, 'XYLOMIA', 'XY543SF', 'Così leggeri, non ti accorgerai nemmeno di indossarli. Con le aste in legno fatte a mano, le cerniere di qualità e la montatura in plastica, gli occhiali da sole unisex glozzi saranno i tuoi occhiali preferiti.\nSe stai cercando una montatura elegante, grazie alla sua venatura noce; e cerchi un occhiale comodo da indossare, grazie alle sue cerniere elasticizzate, questo è il modello che fa per te, ti rimane solo la scelta della lente!', 'legno', 'da sole', 'unisex', 'marrone', 95),
