...
--
-- Host: 127.0.0.1
-- Creato il: Gen 08, 2023 alle 17:36
...
(17, 'Burberry', 'PR09ZV', 'La qualità totale come punto di partenza, la costante innovazione nel rispetto della tradizione, la ricerca e la selezione dei materiali coniugata ad un\'impeccabile manifattura: gli occhiali Prada sono contraddistinti da uno stile inconfondibile.\r\n\r\nScegli il tuo stile Prada e scopri il modello PR 09ZV\r\n\r\nGenere: donna\r\nColore della montatura: miele tartarugato\r\nMateriale della montatura: acetato\r\nForma: squadrata\r\nTipo di montatura: cerchio intero\r\nColore delle lenti: lente demo\r\nTrattamenti: lente demo\r\n\r\nVestibilità e caratteristiche della montatura\r\n\r\nVestibilità standard.\r\n', 'plastica', 'da vista', 'da uomo', 'nero', 290),
...
(21, 'XYLOMIA', 'XYLADM30', 'Gli strati di legno colorati a contrasto donano particolarità. Le montature FEB 31st sono realizzate in legno utilizzando tecniche di lavorazione all\'avanguardia che le rende resistenti, sottili e leggere. Gli abbinamenti di colori del legno e la cura per dettagli rendono queste montature molto importanti. Ideali per chi non vuole portare la solita montatura in acetato.', 'legno', 'da vista', 'da uomo', 'marrone', 130),
(22, 'XYLOMIA', 'XYLA32MD', 'Con questi eleganti occhiali da sole per uomo e donna stabilisci le tendenze del momento. Dalla natura con la natura, la leggerissima struttura in legno di pero si adagia comodamente sul tuo viso.', 'legno', 'da vista', 'unisex', 'marrone', 80),
(23, 'Oakley', 'XY432TD', 'Il calore del legno e la lavorazione artigianale si uniscono alle lenti polarizzate per un occhiale dal design moderno e ricercato, per un accessorio di moda funzionale, pratico e contemporaneo per lei e per lui.', 'legno', 'da vista', 'da uomo', 'marrone', 86),
...
(25, 'Oakley', 'OAK201', 'Così leggeri, non ti accorgerai nemmeno di indossarli. Con le aste in legno fatte a mano, le cerniere di qualità e la montatura in plastica, gli occhiali da sole unisex glozzi saranno i tuoi occhiali preferiti.\r\nSe stai cercando una montatura elegante, grazie alla sua venatura noce; e cerchi un occhiale comodo da indossare, grazie alle sue cerniere elasticizzate, questo è il modello che fa per te, ti rimane solo la scelta della lente!', 'legno', 'da vista', 'da uomo', 'marrone', 70);
